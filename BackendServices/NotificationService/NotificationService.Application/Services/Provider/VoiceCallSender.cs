...
namespace NotificationService.Application.Services.Provider
{
    public class VoiceCallSender : IVoiceCallSender
    {
        ...
        public async Task SendVoiceMessageAsync(string phoneNumber, string message)
        {
            ...
            try
            {
                ...
                // ==========================================================
                // TODO:
                // Replace this mock implementation with a real
                // voice call provider.
                //
                // Examples:
                // - Twilio Voice
                ...
                //
                // Example:
                // await _voiceProvider.MakeCallAsync(phoneNumber, message);
                // ==========================================================
        ...
        public async Task SendOtpCallAsync(string phoneNumber, string otp)
        {
            ValidatePhoneNumber(phoneNumber);
